export default function MacbookDark({ url }) {
    ...
    return (
        ...
        >
            <span className="flex flex-row justify-left items-center absolute top-0 left-0 w-full h-[40px] object-cover z-10" style={{ backgroundColor: "#191C1F", paddingLeft: "15px" }}>
